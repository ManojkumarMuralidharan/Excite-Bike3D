...
public static var finish_mins:int ;
public static var finish_seconds:int ;
public static var finish_fractions:int ;
...
function Start()
{	
this.mainMenuButtonObj = GameObject.Find("MainMenu_switcher"); 
...
function GetInput()
{
   for (var touch : Touch in Input.touches) {
	...
	dir.y = -Input.acceleration.x; // Z is the axis which controls left and right.
	...
	//Debug.Log("Steer is "+steer+"Input x"+dir.x);
...
var guiTime = Time.time ;
   ...
   finish_fractions=fraction;
   //var guiLabel:GUI.Label;
   //guiLabel=
   GUI.contentColor = Color.black;
   
   GUI.backgroundColor=Color.gray;
   GUI.Button(Rect (350, 410, 100,50), textTime);
   //GUI.Label (Rect (200, 490, 100, 100), textTime); 
